...
public class GeneralizedGoertzelTest {
    ...
    public void testSelCallDetection() throws UnsupportedAudioFileException, IOException {
        ...
        InputStream stream = TestUtilities.ccirFile();
        AudioDispatcher ad = AudioDispatcherFactory.fromInputStream(stream, blockSize,0);
        ad.addAudioProcessor(generalized);
        ad.run();

        assertEquals(symbolsAccumulator, "042E1", "The selCall decoded it");
    }
