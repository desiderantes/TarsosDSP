...
public class PitchShiftingExample extends JFrame implements TarsosDSPDemo {
    ...
    private ChangeListener parameterSettingChangedListener = new ChangeListener() {
        ...
        public void stateChanged(ChangeEvent changeEvent) {
            if (changeEvent.getSource() instanceof JSpinner) {
                int centValue = Integer.parseInt(((JSpinner) changeEvent.getSource())
                        .getValue().toString());
    ...
    public PitchShiftingExample() {
        ...
        gainSlider.addChangeListener(changeEvent -> {
            if (PitchShiftingExample.this.dispatcher != null) {
    ...
    private static void startGui() {
        new PitchShiftingExample().start();
    }
