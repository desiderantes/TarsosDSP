...
public class AdvancedAudioPlayer extends JFrame implements TarsosDSPDemo {
    ...
    public static void main(String... args) {
        new AdvancedAudioPlayer().start(args);
    }
    ...
    private JComponent createButtonPanel() {
        ...
        stopButton.addActionListener(actionEvent -> player.stop());
