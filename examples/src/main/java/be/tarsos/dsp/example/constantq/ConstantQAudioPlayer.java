...
import be.tarsos.dsp.example.TarsosDSPDemo;
...
public class ConstantQAudioPlayer extends JPanel implements TarsosDSPDemo {
    ...
    public static void main(String... args) throws InterruptedException, InvocationTargetException {
       new ConstantQAudioPlayer().start(args);
    }
    ...
    private Component createConstantQ() {
        ...
        ViewPortChangedListener listener = newViewPort -> {
            waveForm.repaint();
            constantQ.repaint();
        };
    ...
    public String getDescription() {
        return "Constant Q Audio Player";
    }
    ...
    public void start(String... args) {
        try {
            SwingUtilities.invokeAndWait(() -> {
                ...
                frame.setTitle(this.getDescription());
