...
public class MidiParser {
    ...
    private static boolean noteIsOff(MidiEvent event) {
        return Integer.toString(event.getMessage().getStatus(), 16)
    ...
    private static boolean noteIsOn(MidiEvent event) {
        return Integer.toString(event.getMessage().getStatus(), 16).toUpperCase()
                .charAt(0) == '9';
    }
    ...
    private static boolean changeTemp(MidiEvent event) {
        return Integer.valueOf(
                ("" + Integer
                        .toString(event.getMessage().getStatus(), 16)
                ...
                ("" + Integer.toString(event
                        ...
                        .charAt(1)), 16) == 15
                && Integer
                .toString(event.getMessage().getMessage()[1], 16)
                .toUpperCase().length() == 2
                && Integer
                .toString(event.getMessage().getMessage()[1], 16)
                .toUpperCase().equals("51")
                && Integer
                .toString(event.getMessage().getMessage()[2], 16)
