...
public class Resynthesizer {
    ...
    public static void main(String... arguments) {
        if (arguments.length == 0) {
            new GraphicalResynthesizer().start(arguments);
        } else {
            new CommandLineResynthesizer(arguments);
        }
    }

    public static class GraphicalResynthesizer extends JFrame implements TarsosDSPDemo {
        ...
        public GraphicalResynthesizer() {
            ...
            estimationGainSlider.addChangeListener(changeEvent -> {
            ...
            sourceGainSlider.addChangeListener(changeEvent -> {
        ...
        private void run(String[] args) throws UnsupportedAudioFileException, IOException, IllegalArgumentException, LineUnavailableException {
            ...
            dispatcher.addAudioProcessor(new AudioProcessor() {
                ...
                public boolean process(AudioEvent audioEvent) {
                    ...
                    System.err.print(String.format("\b\b\b\b\b %f", audioEvent.getProgress()));
                    return true;
                }
            });
            dispatcher.run();
