...
public class Delay extends JFrame implements TarsosDSPDemo {
    ...
    PropertyChangeListener mixerChangedListener = arg0 -> {
        try {
    ...
    public Delay() {
        ...
        echoLengthSlider.addChangeListener(arg0 -> {
            if (delayEffect != null) {
        ...
        decaySlider.addChangeListener(arg0 -> {
            if (delayEffect != null) {
